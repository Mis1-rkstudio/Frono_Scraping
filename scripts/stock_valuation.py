...
from df_cleaners.cleaner import modify_valuation_dataframe
...
def getStockValuation(location):
    ...
    try:
        ...
        # Upload to BigQuery
        upload_to_bigquery(df, table_name="stock_valuation", location=location)
